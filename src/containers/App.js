...
class App extends Component {
    ...
    formOnSubmit = value => {
        this.state.initData.push({"title" : value, "id" : this.generateId, isDone: false, onEdit: false });
        this.setState({ initData : this.state.initData });
    }; 

    prepareInitData (arr) {
        return arr.reduce((result, item) => {
            result.push({"title" : item, "id" : this.generateId, isDone: false, onEdit: false });
            return result;
        }, []);
    }
        ...
        return (
            <div className="container">
                <div className="row">
                 ...
                 <div className="row">
                    <List items={this.state.initData} 
